                              ...
                              <form action="" name=<?php if(isset($queries['token'])){echo "login.php?token=".$queries['token'];} else{echo "login.php";}?> method="post">
                                 <div class="row">
                                    <div class="form-group col-sm-6">
                                       ...
                                       <input type="text" name="usercont" id="id" class="form-control" placeholder="Registered UserId"
                      required="true" >
                                    </div> </div>
                                    <div class="row">
                                    <div class="form-group col-sm-6">
...
<h6 style="padding-top: 20px"><a href="forgpass.php">Forgot Password?</a></h6> 
                                    </div>
