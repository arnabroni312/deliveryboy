...
$query=mysqli_query($con,"select ID from tbldeli where ID='$userid' and   password='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update tbldeli set password='$newpassword' where ID='$userid'");
